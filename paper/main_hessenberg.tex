...
\title{Some practices for Lean formalization by prompt design}
\author{
...
We validate this approach by providing a publicly available Lean 4 case study in combinatorial matrix theory. This project's mathematical content is also published at \href{https://www.astrolabe.network/writing/hessenberg-digraphs}{\texttt{astrolabe.network}}, a prototype platform for publishing and organizing mathematical knowledge, as a navigable, content-addressable semantic network connecting prose, formal statements, proofs, and dependencies.
...
\input{sections/sec-formalization}
\input{sections/sec-results}

\appendix
\input{sections/sec-compression}
\input{sections/sec-appendix-stats}
